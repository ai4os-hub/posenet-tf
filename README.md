...
[![Build Status](https://jenkins.services.ai4os.eu/buildStatus/icon?job=AI4OS-hub/ai4os-posenet-tf/main)](https://jenkins.services.ai4os.eu/job/AI4OS-hub/job/ai4os-posenet-tf/job/main)
...
```bash
git clone https://github.com/ai4os-hub/ai4os-posenet-tf
cd ai4os-posenet-tf
pip install -e .
...
The folder `ai4os_posenet_tf` is designed to contain the source
...
The only requirement is that the folder `ai4os_posenet_tf` contains
...
another file. See the [README.md](./ai4os_posenet_tf/README.md)
in the `ai4os_posenet_tf` folder for more information.
...
the [README.md](./ai4os_posenet_tf/README.md)
