...
LABEL maintainer='Lara Lloret (CSIC)'
LABEL version='0.1.0'
...
# Install user app
RUN git clone -b $branch --depth 1 https://github.com/ai4os-hub/ai4os-posenet-tf && \
    pip3 install --no-cache-dir -e ./ai4os-posenet-tf
